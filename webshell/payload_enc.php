...
$conn_str_enc = "base encoded url here"; 
$tunnel_url = base64_decode($conn_str_enc);
...
$fp = stream_socket_client($tunnel_url, $errno, $errstr, 30, STREAM_CLIENT_CONNECT, $context);
